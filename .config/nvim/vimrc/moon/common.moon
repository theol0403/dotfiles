...
-- export bind = (mode, lhs, rhs) -> vim.keymap.set mode, lhs, rhs, {remap:true}
-- export nobind = (mode, lhs, rhs) -> vim.keymap.set mode, lhs, rhs, {remap:false}
-- export map = (...) -> bind {'n', 'v', 'o'}, ...
-- export noremap = (...) -> nobind {'n', 'v', 'o'}, ...
-- export nmap = (...) -> bind 'n', ...
-- export nnoremap = (...) -> nobind 'n', ...
-- export imap = (...) -> bind 'i', ...
-- export inoremap = (...) -> nobind 'i', ...
-- export omap = (...) -> bind 'o', ...
-- export onoremap = (...) -> nobind 'o', ...
-- export xmap = (...) -> bind 'x', ...
-- export xnoremap = (...) -> nobind 'x', ...
-- export vmap = (...) -> bind 'v', ...
-- export vnoremap = (...) -> nobind 'v', ...
-- export tmap = (...) -> bind 't', ...
-- export tnoremap = (...) -> nobind 't', ...
